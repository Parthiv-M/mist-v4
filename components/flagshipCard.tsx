...
const FlagShipCard = (props: FlagShipType) => {
    return (
        <div data-aos="fade-up" className="p-4 border border-neutral-800/80 flex flex-col justify-center items-start rounded-xl hover:shadow-3xl hover:border-transparent">
            <div className="flex items-center gap-3">
                <img src={`/images/${props?.image}`} className="h-10 rounded-lg border border-neutral-800/70 shadow-xl" />
